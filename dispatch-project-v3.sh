#!/usr/bin/env bash
# goai-crisis-cloud-bridge · DSH 格式云端派单（juchang-agentteams-dsh-project@1 信封 · v3: p4 全新 dispatchId（p2/p3 为 Leader 中断半成品，留作失败样本））
...
DISPATCH_ID='cloud-crisis-2014-east-art-center-p4'
