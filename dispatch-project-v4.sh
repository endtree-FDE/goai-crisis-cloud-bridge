#!/usr/bin/env bash
# goai-crisis-cloud-bridge · DSH 格式云端派单（juchang-agentteams-dsh-project@1 信封 · v4: p5（在 reset-and-redispatch 清理后发送））
...
DISPATCH_ID='cloud-crisis-2014-east-art-center-p5'
